let iataCodeCity = "WAW"; 
let AIRPORT_LOCATION = "WARSAW"; 
let flightStatusUpdates = []; 
let showDefaultTicker = true; 

function generateConfiguration(iataCodeCity) {
    return {
        "Configuration": [
            {
                "type": "hidden",
...
function createChannel() {
    ...
    channel.subscribe("get", (response) => {
        ...
        console.log("Show Default Ticker:", showDefaultTicker); // Debugging log
                ...
                content: [
                    {
                        ...
                        config: generateConfiguration(selectedIataCode)
                    },
                    {
                        resourceType: "content",
